...
CANDIDATOS = [
    ("MeteoGalicia camaras JSON", "https://servizos.meteogalicia.gal/rss/predicion/jsonCamaras.action"),
    ("MeteoGalicia camaras (alt)", "https://servizos.meteogalicia.gal/rss/predicion/jsonCamaras.action?idZona=&request_locale=es"),
    ("Open Data Euskadi camaras trafico", "https://api.euskadi.eus/traffic/v1.0/cameras"),
    ("Open Data Euskadi camaras paginado", "https://api.euskadi.eus/traffic/v1.0/cameras?_page=1"),
    ("Euskalmet estaciones", "https://api.euskadi.eus/euskalmet/stations"),
    ("Navarra open data camaras", "https://datosabiertos.navarra.es/api/3/action/package_search?q=camaras"),
    ("Aragon camaras trafico", "https://opendata.aragon.es/GA_OD_Core/download?view_id=97&formato=json"),
    ("Illes Balears camaras", "https://catalegdades.caib.cat/api/views/metadata/v1?q=cameres"),
    ("datos.gob.es catalogo camaras", "https://datos.gob.es/apidata/catalog/dataset/title/camaras?_pageSize=20&_page=0"),
]
